...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton.setText(QCoreApplication.translate("MainWindow", u"Ask to talk", None))
        self.pushButton_2.setText(QCoreApplication.translate("MainWindow", u"Change name", None))
        self.pushButton_3.setText(QCoreApplication.translate("MainWindow", u"Open Chat", None))
        self.label.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><span style=\" font-size:16pt; font-weight:700;\">Hello, {name}</span></p></body></html>", None))
    # retranslateUi
